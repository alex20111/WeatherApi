...
public class Location {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(type).append(country).append(countryIso3166).append(countryName).append(state).append(city).append(tzShort).append(tzLong).append(lat).append(lon).append(zip).append(magic).append(wmo).append(l).append(requesturl).append(wuiurl).append(nearbyWeatherStations).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(type, rhs.type).append(country, rhs.country).append(countryIso3166, rhs.countryIso3166).append(countryName, rhs.countryName).append(state, rhs.state).append(city, rhs.city).append(tzShort, rhs.tzShort).append(tzLong, rhs.tzLong).append(lat, rhs.lat).append(lon, rhs.lon).append(zip, rhs.zip).append(magic, rhs.magic).append(wmo, rhs.wmo).append(l, rhs.l).append(requesturl, rhs.requesturl).append(wuiurl, rhs.wuiurl).append(nearbyWeatherStations, rhs.nearbyWeatherStations).isEquals();
    }
